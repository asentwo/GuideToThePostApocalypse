...
extension Round4_ViewConroller {
  ...
  func AddAllGraphics() {
    ...
    let btn = UIButton(frame: CGRect(x: 60, y: 510, width: 250, height: 50))
    btn.hidden = true
    btn.tag = 1
    ...
    btn.addTarget(self, action: "switchToRoundFive:", forControlEvents: .TouchUpInside)
