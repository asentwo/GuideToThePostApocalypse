...
extension Round6_ViewController {
  ...
  func AddAllGraphics() {
    ...
    survivedLabel.frame = CGRectMake(50, -70, 400, 400)
    survivedLabel.text = youSurvivedMessage
    survivedLabel.shadowColor = UIColor.blackColor()
    survivedLabel.shadowOffset = CGSize(width: 1, height: 1)
    survivedLabel.font = UIFont(name: "Overseer", size: 40)
    survivedLabel.textColor = UIColor.whiteColor()
    self.view.addSubview(survivedLabel)
